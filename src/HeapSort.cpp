...
const int HeapSort::obtainLeftChildUbication(std::vector<int>& intsVec, int fatherUbication){
    return 2*fatherUbication + 1;
};

/*This method takes care of obtaining the ubication of a right child given the vector 
and the ubication of the father*/
const int HeapSort::obtainRightChildUbication(std::vector<int>& intsVec, int fatherUbication){
    return 2*fatherUbication + 2;
};

/*This method takes care of obtaining the ubication of a right child given the vector 
and the ubication of the father*/
const int HeapSort::obtainFatherUbication(std::vector<int>& intsVec, int childUbication){
...
void HeapSort::heapify(std::vector<int>& intsVec,int crrntChildUbication, int lastSortedValUbication){
...
std::vector<int>& HeapSort::maxHeapify(std::vector<int>& intsVec,int sortedLastPoint){
